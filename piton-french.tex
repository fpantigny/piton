...
seront exécutés dans le cas où le fichier a été trouvé (lettre |T|) ou pas (lettre |F|).
...
lignes, ni entre les $n$~dernières.\footnote{Remarquer que l'on parle des lignes du
  listing d'origine, une telle ligne pouvant être composée sur plusieurs lignes dans le
  PDF final si la clé |break-lines-in-Piton| est utilisée.} 
