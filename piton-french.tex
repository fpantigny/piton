...
Quand la clé |split-on-empty-lines| est activée, le travail effectué va en fait un plus loin que d'autoriser une
coupure de page : les lignes vides successives sont supprimées et remplacées par le contenu du paramètre
correspondant à la clé \Definition{split-separation}. 
La valeur initiale de ce paramètre est |\vspace{\baselineskip}\vspace{-1.25pt}|, ce qui, au final, correspond à
une ligne vide dans le PDF final (cet espace vertical est supprimé s'il tombe au niveau d'un saut de page).
