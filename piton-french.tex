...
\medskip
L'extension \pkg{piton} propose une commande \DefinitionCommande{NewPitonLanguage} pour définir de nouveaux
...
\bigskip
On renvoie à la documentation de l'extension \pkg{listings} pour la signification des clés |morekeywords|,
|sensitive|, |morecomment|, |morestring|, etc.
