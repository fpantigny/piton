...
Cette clé possède aussi une syntaxe additive avec, c'est-à-dire que l'on peut
...
lettres |i|, |l|, |s|, |n| et |f|\footnote{Pour la lettre |f|, seule une spécification de commentaire commençant en  première colonne est autorisée.})), |moredelim| (avec les lettres |i|, |l|, |s|, |*| et |**|),
...
Initialement, les caractères |@| et |_| sont considérés comme des lettres (au sens de \pkg{listings})
car de nombreux langages de programmation les autorisent dans les mots-clés et les identificateurs. Avec
