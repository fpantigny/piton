...
\usepackage[footnotehyper,begin-escape=!,end-escape=!,math-comments]{piton}
...
La clé \Definition{math-comments}, qui n'est disponible qu'au chargement de \pkg{piton} (c'est-à-dire au moment du 
...
\subsubsection{Le mécanisme «espace»}
...
le terminant) en utilisant les clés \Definition{begin-escape} et \Definition{end-escape} au chargement de
\pkg{piton} (c'est-à-dire au moment du |\usepackage{piton}|). Les deux délimiteurs peuvent être identiques.
...
\begin{Verbatim}
\usepackage[~emphase#begin-escape=!,end-escape=!@]{piton}
\end{Verbatim}
