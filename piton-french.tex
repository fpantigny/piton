...
\item \index{rounded-corners} \colorbox{yellow!50}{\textbf{Nouveau 4.7}}
...
\smallskip
La commande |\rowcolor| ne prend qu'un seul argument qui est la couleur demandée :
il n'y a pas d'argument optionnel pour l'espace colorimétrique.\footnote{Néanmoins, il est possible
d'écrire, par exemple : \verb|\rowcolor{[rgb]{0.8,1,0.8}}|.}
